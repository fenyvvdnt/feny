      ...
      <div class="row">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input type="text" name="top_notes" class="form-control" value="{{ old('top_notes', $product->notes['top'] ?? '') }}" placeholder="Contoh: Bergamot, Lemon">
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
            <label>Middle Notes</label>
            <input type="text" name="middle_notes" class="form-control" value="{{ old('middle_notes', $product->notes['middle'] ?? '') }}" placeholder="Contoh: Jasmine, Rose">
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
            <label>Base Notes</label>
            <input type="text" name="base_notes" class="form-control" value="{{ old('base_notes', $product->notes['base'] ?? '') }}" placeholder="Contoh: Musk, Amber">
          </div>
        </div>
      </div>
      <div class="form-group">
